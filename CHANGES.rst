...
-------------------
------------------------
- Gitchangelog fix. [Halvor Holsten Strand]
...
- Modification. [Halvor Holsten Strand]
- Silly rename to do workflow testing. [Halvor Holsten Strand]
- Silly rename to do workflow testing. [Halvor Holsten Strand]
- Attempt at solving Git commit related issue. [Halvor Holsten Strand]
- Silly rename to do workflow testing. [Halvor Holsten Strand]
- Learning I probably have to checkout and setup Python. [Halvor Holsten
  Strand]
- Just fixing broken things. [Halvor Holsten Strand]
- Silly rename to do workflow testing. [Halvor Holsten Strand]
- Went with repo url instead of repo to avoid config file. [Halvor
  Holsten Strand]
- Attempt at a manually triggered workflow to execute a release. [Halvor
  Holsten Strand]
